...
# Application and Service Parameters Part 2
    ...
    ('user_class', None, None),
    ('directory_agent', None, None),
    ('service_scope', None, None),
    ('rapid_commit', None, None),
    ('client_fqdn', None, None),
    ('relay_agent_information', None, None),
    ('isns', None, None),
    ('removed_unassigned', None, None),
    ('nds_servers', None, None),
    ('nds_tree_name', None, None),
    ('nds_context', None, None),
    ('bcmcs_controller_domain_name_list', None, None),
    ('bcmcs_controller_ipv4_address', None, None),
    ('authentication', None, None),
    ('client_last_transaction_time', None, None),
    ('associated_ip', None, None),
    ('client_system', None, None),
    ('client_ndi', None, None),
    ('ldap', None, None),
    ('removed_unassigned', None, None),
    ('UUID_GUID', None, None),
    ]
